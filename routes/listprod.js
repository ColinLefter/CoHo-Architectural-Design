...
router.get('/', async function(req, res, next) {
  try {
    ...
    let query = "SELECT productId, productName, productPrice, categoryName FROM product JOIN category ON product.categoryId = category.categoryId WHERE productName LIKE @name";
